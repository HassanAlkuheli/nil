...
contract NilVault is ReentrancyGuard, Ownable {
    ...
    event Deposited(address indexed user, uint256 ethAmount, uint256 nilAmount);
    event Redeemed(address indexed user, uint256 nilAmount, uint256 ethAmount);
    ...
    function deposit() external payable nonReentrant {
        ...
        uint256 nilAmount = (msg.value * 100) / COLLATERAL_RATIO;
        ...
        emit Deposited(msg.sender, msg.value, nilAmount);
    }
    ...
    function redeem(uint256 nilAmount) external nonReentrant {
        ...
        uint256 ethAmount = (nilAmount * COLLATERAL_RATIO) / 100;
        ...
        emit Redeemed(msg.sender, nilAmount, ethAmount);
    }
    ...
    function getStats() external view returns (uint256, uint256, uint256) {
        return (totalETHLocked, totalNILMinted, totalUsers);
    }
}
